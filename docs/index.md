...
:::info 新玩家请依次阅读以下内容：
1. **[安装和开始](./install_and_start.md)** - 如何安装客户端和连接服务器
2. **[注意事项](./notice.md)** - 必读的规则和禁止事项
3. **[提出需求](./asking_requirements.md)** - 如何正确地反馈问题
:::
...
## ex.1 腐竹
MagicMakes / NEIKI （一个人两个名字，也许罢）
<img src="/public/截屏2026-04-18 上午9.47.46.png" style="width: 30%; height: auto;" />
<img src="/public/pic1.jpg" style="width: 10%; height: auto;" />

## ex.2 来自`@再也不剪宣传片了`
🦐🐔8⃣️剪
<iframe 
  src="//player.bilibili.com/player.html?isOutside=true&aid=116068722934216&bvid=BV1H6Z7BwE5J&cid=36075013283&p=1&autoplay=0" 
  width="40%" 
  height="260" 
  frameborder="no" 
  scrolling="no" 
